"""CLI entrypoint for the dual-arm interactive runtime."""
...
from linkerbot_sim.app.runtime.dual_robot import create_dual_robot_runtime
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Foxglove live server port；双臂日常调试建议 8766；不传则不开状态流",
    )
