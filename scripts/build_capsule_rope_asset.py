...
from manipulation_project.objects.capsule_rope import CapsuleRopeConfig, write_capsule_rope_asset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--config", type=Path, default=Path("configs/objects/capsule_rope.yaml"))
...
def main() -> None:
    ...
    try:
        output = write_capsule_rope_asset(config, repo_path(args.output) if args.output is not None else None)
        print(
